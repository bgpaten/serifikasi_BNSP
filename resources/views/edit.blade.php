    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form action="{{ route('daftar.update', $data->id) }}" method="post">
                    @method('PUT')
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 col-md-4">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="tempat_lahir" value="{{ $data->tempat_lahir }}"
                                    ...
                                    id="basic-icon-default-fullname" placeholder="Masukkan Nama Buku" aria-label="John Doe"
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-md-2 col-form-label" for="basic-icon-default-fullname">Asal Sekolah <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10 col-md-4">
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i
