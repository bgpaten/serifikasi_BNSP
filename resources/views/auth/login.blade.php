...
<body>
    ...
    <form method="POST" action="{{ route('login') }}" id="login-form" class="login-form" autocomplete="off"
        role="main">
        @csrf
        <h1 class="a11y-hidden">Login Form</h1>
        <div>
            <label class="label-email">
                <input type="email" class="text" name="email" placeholder="Username" tabindex="1" required />
